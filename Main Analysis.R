...
VA_Unemployment <- read.csv("C:/Users/lilni/OneDrive - Mount St. Mary's University/Desktop/FRED Data Science/VA_Unemployment.csv")
# Annual Unemployment Percentage in DC
DC_Unemployment <- read.csv("C:/Users/lilni/OneDrive - Mount St. Mary's University/Desktop/FRED Data Science/DC_Unemployment.csv")
# Annual Percentage of DC Employed and Unemployed workers divided against state's Civilian Population
DC_Labor <- read.csv("C:/Users/lilni/OneDrive - Mount St. Mary's University/Desktop/FRED Data Science/DC_Labor_Force.csv")
